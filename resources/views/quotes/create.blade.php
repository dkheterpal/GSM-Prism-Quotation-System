        ...
        <form id="quote-form" action="{{ route('quotes.store') }}" method="POST"
            ...
            <div class="p-8 border-b border-slate-100 bg-slate-50/50 rounded-t-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <input type="hidden" name="notes" id="hidden_notes_grid" value="">
                </div>
            </div>
            ...
            <div class="p-8 border-b border-slate-100 bg-amber-50/30">
                ...
                <div>
                    <textarea name="notes" rows="4"
                        ...
                        placeholder="These notes are invisible to the customer and will NOT appear on the final PDF. Use this space for pricing rationale, discounts given, or general tracking..."></textarea>
                </div>
            </div>
